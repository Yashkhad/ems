...
const Login = () => {
  ...
  const [email, setEmail] = useState('yash.khade@ems.com')
  const [password, setPassword] = useState('Gm@12345')
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex md:w-1/2">
        <img
          ...
          alt="Employee Management System Hero"
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center gap-3">
              ...
              <div className="text-left">
                <h1 className="text-brand-primary text-xl font-bold">EMS</h1>
