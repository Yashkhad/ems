...
export const faceAPI = {
  register: (data) => {
    ...
    if (data instanceof FormData) {
      return api.post('/face/register', data)
    }
    return api.post('/face/register', { face_descriptor: data })
  },
  registerForUser: (userId, data) => {
    if (data instanceof FormData) {
      return api.post(`/face/register/${userId}`, data)
    }
    return api.post(`/face/register/${userId}`, { face_descriptor: data })
  },
