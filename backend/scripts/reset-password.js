 ...
 * Example: node scripts/reset-password.js dishant.sevake@ems.com NewPass@123
 */
...
Examples:
  node scripts/reset-password.js dishant.sevake@ems.com NewPass@123
  node scripts/reset-password.js admin@ems.com Admin@123
  node scripts/reset-password.js --list
`);
  process.exit(0);
}
