...
async function main() {
  ...
  try {
    ...
    await prisma.attendanceConfig.deleteMany();
    console.log(' Cleanup successful.');
  } catch (error) {
    console.log(' Cleanup skipped (tables might not exist).');
  }
  ...
  const users = [
    ...
    {
      employeeId: 'EMS0003',
      email: 'parikshit.thakre@ems.com',
      passwordHash: defaultPassword,
      firstName: 'Parikshit',
      lastName: 'Thakre',
      phone: '+91-9876543212',
  ...
  console.log('   HR (Vedant Katore):       vedant.katore@ems.com / Admin@123');
  console.log('   Manager (Parikshit Thakre): parikshit.thakre@ems.com / Admin@123');
  console.log('   Employee (Sujal Ghagare):  sujal.ghagare@ems.com / Admin@123');
  console.log('   Director (Yash Khade):    yash.khade@ems.com / Gm@12345');
}
