...
// EMS office location configuration (can be moved to database config if needed)
// EMS Borgaon Factory - Chhindwara, Madhya Pradesh (100 acres)
const EMS_OFFICE_LOCATION = {
    latitude: 22.14,    // EMS Borgaon coordinates
    longitude: 78.77,
...
async function getLocationVerificationSetting() {
    // Location verification disabled as per user request
    return false;
}
